...
import org.iets3.process.dashboard.behavior.TableRenderer;
import javax.swing.JScrollPane;
import java.awt.Dimension;

public class DashboardHintDisplayer_TabularView_Editor extends DefaultNodeEditor {
  private Collection<String> myContextHints = Arrays.asList(new String[]{"org.iets3.process.dashboard.editor.DashboardVisualisation.TabularView"});
  @Override
  @NotNull
  ...
  private static JComponent _QueryFunction_JComponent_m9rjtm_a7a(final SNode node, final EditorContext editorContext) {
    ...
    final Iterable<SNode> states = ListSequence.fromList(SModelOperations.roots(flowModel, MetaAdapterFactory.getConcept(0x102111329b5e427aL, 0x9b371c1f28794a5eL, 0x3b5f775e0d415b00L, "org.iets3.process.dashboard.structure.FlowData"))).translate(new ITranslator2<SNode, SNode>() {
