...
public class ModelHolder_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_gwj1q3_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createDiagram_gwj1q3_b0(editorContext, node));
    return editorCell;
  }
  private EditorCell createConstant_gwj1q3_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "MatchModel:");
    editorCell.setCellId("Constant_gwj1q3_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createDiagram_gwj1q3_b0(final EditorContext editorContext, final SNode node) {
              ...
              public void run() {
                ContextVariables.withValue("thisNode", node, new Runnable() {
                  public void run() {
                    ...
                    editorCell.value.setCellId("Diagram_gwj1q3_b0");
                    Style style = new StyleImpl();
                    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, 0, true);
                    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, 0, true);
                    style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-color"), 0, StyleRegistry.getInstance().getSimpleColor(ModelHolder_Editor._StyleParameter_QueryFunction_gwj1q3_a2b0(editorContext, node)));
                    style.set(StyleAttributes.getInstance().<Float>getAttribute("de.itemis.mps.editor.diagram.styles", "__line-width"), 0, ModelHolder_Editor._StyleParameter_QueryFunction_gwj1q3_a3b0(editorContext, node));
  ...
  private static Color _StyleParameter_QueryFunction_gwj1q3_a2b0(EditorContext editorContext, SNode node) {
    return Color.darkGray;
  }
  private static Float _StyleParameter_QueryFunction_gwj1q3_a3b0(EditorContext editorContext, SNode node) {
    return 2.0f;
  }
}
